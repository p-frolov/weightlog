...
rest_api_patterns = [
    ...
    url(r'^trainings/(?P<training_id>[0-9]+)/sets/$', views.TrainingSetsList.as_view(), name='training-set-list'),

    url(r'^trainingnames/$', views.TrainingNamesList.as_view(), name='training-name-list'),

    url(r'^sets/$', views.SetsList.as_view(), name='set-list'),
